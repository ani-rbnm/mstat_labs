...
------------------------------------------------------------------------------------------------------------------------
--
-- Cement Production Data - Seasonal Plot.
--
-- Description: In this script a seasonal polt for the Cement Production data set is created.
--
-- Content:     0. Set-up
--              1. Data
--              2. Seasonal Plot
...
# Define file path
file = "Workshop 1 - Solution codes/Exercise 1.2/CementProduction.xls"

# Load cement production data
series = pd.read_excel(file, sheet_name='Sheet1', index_col=0, parse_dates=True).squeeze()
...
# Select a few years
years = np.arange(2001, 2008)

# Create seasonal plot
seasonal_data.loc[:, years].plot(title="Cement Production", xlabel="Month", ylabel="Thousand tonnes")
plt.show()
