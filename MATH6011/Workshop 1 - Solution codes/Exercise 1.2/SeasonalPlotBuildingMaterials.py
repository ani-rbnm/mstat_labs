...
------------------------------------------------------------------------------------------------------------------------
--
-- Building Materials Data - Seasonal Plot.
--
-- Description: In this script a seasonal polt for the Building Materials data set is created.
--
-- Content:     0. Set-up
--              1. Data
--              2. Seasonal Plot
...
# Define file path
file = "Workshop 1 - Solution codes/Exercise 1.2/BuildingMaterials.xls"
...
# Select a few years
years = [1987, 1988, 1989, 1990, 2006, 2007]

# Create seasonal plot
seasonal_data.loc[:, years].plot(title="Building Materials Production", xlabel="Month", ylabel="Millions of units")
plt.show()
