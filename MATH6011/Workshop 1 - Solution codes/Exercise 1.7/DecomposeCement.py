...
------------------------------------------------------------------------------------------------------------------------
--
-- Cement Production Data - Seasonal Decomposition.
--
-- Description: In this script the seasonal decomposition is performed for the Cement Production data set.
--
-- Content:     0. Set-up
--              1. Data
...
# Define file path
file = "Workshop 1 - Solution codes/Exercise 1.7/CementProduction.xls"

# Load cement production data
series = pd.read_excel(file, sheet_name='Data', index_col=0, parse_dates=True).squeeze()
