...
------------------------------------------------------------------------------------------------------------------------
--
-- Building Materials Data - Moving Average.
--
-- Description: In this script a moving average is calculated for the Building Materials data set.
--
-- Content:     0. Set-up
--              1. Data
--              2. Plotting
...
# Define file path
file = "Workshop 1 - Solution codes/Exercise 1.5/BuildingMaterialsWithMA.xls"
