...
plot_acf(series, title='ACF of Building Material time series', lags=50, ax=ax[0])

# PACF plot on 50 time lags
plot_pacf(series, title='PACF of Building Material time series', lags=50, ax=ax[1])
