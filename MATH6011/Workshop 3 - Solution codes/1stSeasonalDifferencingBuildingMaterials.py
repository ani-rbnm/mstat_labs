...
------------------------------------------------------------------------------------------------------------------------
--
-- Building Materials Data - First and Seasonal Difference.
--
-- Description: In this script the first and seasonal difference is calculated based on the Building Materials data.
--
-- Content:     0. Set-up
--              1. Data
--              2. Plotting
