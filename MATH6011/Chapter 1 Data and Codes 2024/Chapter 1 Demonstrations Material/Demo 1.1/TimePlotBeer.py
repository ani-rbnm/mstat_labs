...
-- Beer Data - Time Plot.
--
-- Description: In this script a time polt for the Beer data set is created.
--
-- Content:     0. Set-up
--              1. Data
--              2. Time Plot
...
# Define file path
file = "Chapter 1 Data and Codes 2024/Chapter 1 Demonstrations Material/Demo 1.1/Beer.xls"
...
# Create time plot
series.plot(title="Australian Beer Production", xlabel="Month", ylabel="Megaliters")
plt.show()
