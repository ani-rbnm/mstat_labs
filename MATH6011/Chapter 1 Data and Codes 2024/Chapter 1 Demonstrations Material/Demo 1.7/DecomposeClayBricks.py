...
------------------------------------------------------------------------------------------------------------------------
--
-- Clay Bricks Data - Seasonal Decomposition.
--
-- Description: In this script the seasonal decomposition is performed for the Clay Bricks data.
--
-- Content:     0. Set-up
--              1. Data
...
# Define file path
file = "Chapter 1 Data and Codes 2024/Chapter 1 Demonstrations Material/Demo 1.7/ClayBricks.xls"
