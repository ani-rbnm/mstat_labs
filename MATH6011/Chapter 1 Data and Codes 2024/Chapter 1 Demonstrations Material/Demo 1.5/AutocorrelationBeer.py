...
--
-- Description: In this script the ACF for the Beer data set is visualized.
--
-- Content:     0. Set-up
--              1. Data
...
# Define file path
file = "Chapter 1 Data and Codes 2024/Chapter 1 Demonstrations Material/Demo 1.5/Beer.xls"
...
plot_acf(series, title='ACF of Australian beer production data', lags=55)
