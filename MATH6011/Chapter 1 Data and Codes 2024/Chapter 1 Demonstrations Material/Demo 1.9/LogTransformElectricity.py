...
------------------------------------------------------------------------------------------------------------------------
--
-- Electricity Data - Log Transformation.
--
-- Description: In this script the log transformation is performed for the Electricity data.
--
-- Content:     0. Set-up
--              1. Data
--              2. Plotting
...
df['log electricity'] = np.log(df['electricity'])
...
# line plot
plt.subplot(211)
plt.plot(df['log electricity'])
# histogram
plt.subplot(212)
plt.hist(df['log electricity'])
plt.show()
