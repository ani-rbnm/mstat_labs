...
------------------------------------------------------------------------------------------------------------------------
--
-- Beer Data - Seasonal Plot.
--
-- Description: In this script a seasonal polt for the Beer data set is created.
--
-- Content:     0. Set-up
--              1. Data
--              2. Seasonal Plot
...
# Define file path
file = "Chapter 1 Data and Codes 2024/Chapter 1 Demonstrations Material/Demo 1.2/Beer.xls"
...
seasonal_data.plot(title="Monthly Australian Beer Production", xlabel="Month", ylabel="Megalitres")
plt.show()
