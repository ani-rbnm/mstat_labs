...
# Define file path
file = "Chapter 3 Data and Codes 2024/Chapter 3 Demonstrations Material/Demo 3.3/DowJones.xls"
...
plot_acf(series, title='ACF of Dow Jones time series', lags=50, ax=ax[0])

# PACF plot on 50 time lags
plot_pacf(series, title='PACF of Dow Jones time series', lags=50, ax=ax[1])
