...
------------------------------------------------------------------------------------------------------------------------
--
-- Electricity Data - First and Seasonal Difference.
--
-- Description: In this script the first and seasonal difference is calculated based on the electricity data.
--
-- Content:     0. Set-up
--              1. Data
--              2. Plotting
...
# Define file path
file = "Chapter 3 Data and Codes 2024/Chapter 3 Demonstrations Material/Demo 3.5/Electricity.xls"
