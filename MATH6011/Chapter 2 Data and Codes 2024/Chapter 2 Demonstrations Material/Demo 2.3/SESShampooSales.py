...
------------------------------------------------------------------------------------------------------------------------
--
-- Shampoo Sales - Simple Exponential Smoothing.
--
-- Description: In this script the shampoo sales data is used to fit models based on simple exponential smoothing.
--
-- Content:     0. Set-up
--              1. Data
...
# Define file path
file = "Chapter 2 Data and Codes 2024/Chapter 2 Demonstrations Material/Demo 2.3/ShampooSales.xls"
...
AllErrors = pd.DataFrame(
    summary, columns=["Model", "SES model 1", "SES model 2", "SES model 3"]
)
print(AllErrors)
